...
void GrassDemo::BuildField() {
  ...
  meadow.base_color[0] = 0.035f;
  meadow.base_color[1] = 0.15f;
  meadow.base_color[2] = 0.018f;
  meadow.base_color[3] = 0.10f;
  meadow.tip_color[0] = 0.18f;
  meadow.tip_color[1] = 0.43f;
  meadow.tip_color[2] = 0.055f;
  meadow.tip_color[3] = 0.38f;
  meadow.dimensions[0] = 0.42f;
  meadow.dimensions[1] = 0.94f;
  meadow.dimensions[2] = 0.038f;
  meadow.dimensions[3] = 0.078f;
  meadow.shape[0] = 0.04f;
  meadow.shape[1] = 0.30f;
  meadow.shape[2] = 0.25f;
  meadow.shape[3] = 0.08f;
  meadow.material[0] = 0.82f;
  meadow.material[1] = 1.0f;
  meadow.material[2] = 3.2f;
  meadow.material[3] = 0.32f;

  render::GrassType& gold = types_[1];
  gold.base_color[0] = 0.14f;
  gold.base_color[1] = 0.10f;
  gold.base_color[2] = 0.018f;
  gold.base_color[3] = 0.09f;
  gold.tip_color[0] = 0.38f;
  gold.tip_color[1] = 0.27f;
  gold.tip_color[2] = 0.045f;
  gold.tip_color[3] = 0.50f;
  gold.dimensions[0] = 0.65f;
  gold.dimensions[1] = 1.25f;
  gold.dimensions[2] = 0.034f;
  gold.dimensions[3] = 0.068f;
  gold.shape[0] = 0.10f;
  gold.shape[1] = 0.42f;
  gold.shape[2] = 0.32f;
  gold.shape[3] = 0.12f;
  ...
  gold.material[2] = 4.8f;
  gold.material[3] = 0.28f;

  render::GrassType& sage = types_[2];
  sage.base_color[0] = 0.055f;
  sage.base_color[1] = 0.13f;
  sage.base_color[2] = 0.045f;
  sage.base_color[3] = 0.08f;
  sage.tip_color[0] = 0.22f;
  sage.tip_color[1] = 0.34f;
  sage.tip_color[2] = 0.11f;
  sage.tip_color[3] = 0.28f;
  sage.dimensions[0] = 0.28f;
  sage.dimensions[1] = 0.68f;
  sage.dimensions[2] = 0.044f;
  sage.dimensions[3] = 0.092f;
  sage.shape[0] = 0.03f;
  sage.shape[1] = 0.20f;
  sage.shape[2] = 0.16f;
  sage.shape[3] = 0.06f;
  ...
  sage.material[2] = 2.4f;
  sage.material[3] = 0.35f;
  ...
  for (u32 z = 0; z < kResolution; ++z) {
    for (u32 x = 0; x < kResolution; ++x) {
      ...
      sample.density = std::clamp((0.72f + patch * 0.28f) * path_mask, 0.0f, 1.0f);
      sample.growth = 0.78f + patch * 0.38f;
  ...
  domain_.settings.candidate_spacing = 0.39f;
  domain_.settings.stream_tile_size = 18.0f;
  domain_.settings.stream_radius = 84.0f;
  domain_.settings.density_lod_start = 34.0f;
  domain_.settings.density_lod_end = 74.0f;
  domain_.settings.far_density = 0.30f;
  domain_.settings.geometry_lod_start = 24.0f;
  domain_.settings.geometry_lod_end = 58.0f;
  domain_.settings.fade_start = 76.0f;
  domain_.settings.fade_end = 84.0f;
  domain_.settings.max_slope_cos = 0.50f;
  domain_.settings.max_blades = 140000;
}
