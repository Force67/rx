...
# through RX_DLSS_LIB_DIR (x86_64 SDK snippets; on aarch64 the driver
...
if(CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64|AMD64")
  add_library(rx_dlss STATIC IMPORTED GLOBAL)
  set_target_properties(rx_dlss PROPERTIES
    IMPORTED_LOCATION ${DLSS_DIR}/lib/Linux_x86_64/libnvsdk_ngx.a
    INTERFACE_INCLUDE_DIRECTORIES ${DLSS_DIR}/include
    INTERFACE_LINK_LIBRARIES "${CMAKE_DL_LIBS}"
    INTERFACE_COMPILE_DEFINITIONS "RX_DLSS_LIB_DIR=\"${DLSS_DIR}/lib/Linux_x86_64/rel\"")
else()
  add_library(rx_dlss STATIC ${CMAKE_CURRENT_SOURCE_DIR}/ngx_shim/ngx_shim.cc)
  target_include_directories(rx_dlss PUBLIC ${DLSS_DIR}/include)
  target_link_libraries(rx_dlss PUBLIC ${CMAKE_DL_LIBS} volk)
  # No app-shipped snippets on this arch; NGX searches its own driver paths.
  target_compile_definitions(rx_dlss INTERFACE "RX_DLSS_LIB_DIR=\"\"")
endif()
add_library(rx::dlss ALIAS rx_dlss)
