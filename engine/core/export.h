...
#if defined(RX_SCRIPT_IMPLEMENTATION)
#define RX_SCRIPT_EXPORT RX_DSO_EXPORT
#else
#define RX_SCRIPT_EXPORT RX_DSO_IMPORT
#endif
...
#if defined(RX_WORLD_IMPLEMENTATION)
#define RX_WORLD_EXPORT RX_DSO_EXPORT
#else
#define RX_WORLD_EXPORT RX_DSO_IMPORT
#endif
...
#if defined(RX_RENDER2D_IMPLEMENTATION)
#define RX_RENDER2D_EXPORT RX_DSO_EXPORT
#else
#define RX_RENDER2D_EXPORT RX_DSO_IMPORT
#endif
...
#if defined(RX_AUTHORING_IMPLEMENTATION)
#define RX_AUTHORING_EXPORT RX_DSO_EXPORT
#else
#define RX_AUTHORING_EXPORT RX_DSO_IMPORT
#endif
...
#if defined(RX_HTTP_IMPLEMENTATION)
#define RX_HTTP_EXPORT RX_DSO_EXPORT
#else
#define RX_HTTP_EXPORT RX_DSO_IMPORT
#endif
...
#if defined(RX_COMBAT_IMPLEMENTATION)
#  define RX_COMBAT_EXPORT RX_DSO_EXPORT
#else
#  define RX_COMBAT_EXPORT RX_DSO_IMPORT
#endif
...
#if defined(RX_PLACEMENT_IMPLEMENTATION)
#define RX_PLACEMENT_EXPORT RX_DSO_EXPORT
#else
#define RX_PLACEMENT_EXPORT RX_DSO_IMPORT
#endif

#if defined(RX_PLACEMENT_GPU_IMPLEMENTATION)
#define RX_PLACEMENT_GPU_EXPORT RX_DSO_EXPORT
#else
#define RX_PLACEMENT_GPU_EXPORT RX_DSO_IMPORT
#endif
