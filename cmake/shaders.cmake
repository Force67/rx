...
function(rx_embed_shaders target)
  ...
  # NRD.hlsli), passed via the RX_SHADER_INCLUDE_DIRS list variable.
  set(include_flags)
  ...
  foreach(shader ${ARGN})
    ...
    # RX_SHADER_DEPS_<symbol> so edits to the body rebuild the variant.
    set(extra_deps)
    ...
    add_custom_command(OUTPUT ${spv}
      ...
      COMMAND ${RX_DXC} -spirv -fspv-target-env=vulkan1.3 -T ${profile} -E main
    ...
    elseif(RX_RHI_D3D12)
      ...
      add_custom_command(OUTPUT ${dxil}
        COMMAND ${CMAKE_COMMAND} -E make_directory ${CMAKE_CURRENT_BINARY_DIR}/shaders
        COMMAND ${RX_DXC} -T ${dxil_profile} -E main -Qstrip_reflect
